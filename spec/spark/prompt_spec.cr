    ...
    it "correctly asks a question with options" do
      File.tempfile do |output|
        ...
        File.open(tempfile.path) do |input|
          ...
          answer = prompt.select("What is your favorite color?", ["red", "blue", "green"])
          output.rewind.gets_to_end.should eq("What is your favorite color? (1) red (2) blue (3) green ")
          answer.should eq "red"
        end
      end
    end
    ...
    it "correctly asks a question with options and a default answer" do
      File.tempfile do |output|
        ...
        File.open(tempfile.path) do |input|
          ...
          answer = prompt.select("What is your favorite color?", ["red", "blue", "green"], default: "blue")
          output.rewind.gets_to_end.should eq("What is your favorite color? (1) red [2] blue (3) green ")
          answer.should eq "blue"
        end
      end
    end
  end
